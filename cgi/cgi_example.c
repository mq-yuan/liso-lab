...
char *ENVP[] = {
    ...
    "HTTP_REFERER=http://en.wikipedia.org/w/"
    "index.php?title=Special%3ASearch&search=test+wikipedia+search",
    "HTTP_ACCEPT_ENCODING=gzip,deflate,sdch",
    "HTTP_ACCEPT_LANGUAGE=en-US,en;q=0.8",
    "HTTP_ACCEPT_CHARSET=ISO-8859-1,utf-8;q=0.7,*;q=0.3",
    "HTTP_COOKIE=clicktracking-session=v7JnLVqLFpy3bs5hVDdg4Man4F096mQmY; "
    "mediaWiki.user.bucket%3Aext.articleFeedback-tracking=8%3Aignore; "
    ...
    "HTTP_USER_AGENT=Mozilla/5.0 (X11; Linux i686) AppleWebKit/535.1 (KHTML, "
    "like Gecko) Chrome/14.0.835.186 Safari/535.1",
